...
described here: Akka behind NAT or in a Docker container (@ref:[Java](../java/remoting.md#remote-configuration-nat), @ref:[Scala](../scala/remoting.md#remote-configuration-nat))
