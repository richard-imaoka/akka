...
when a **PersistentActor** (@ref:[Java](../java/persistence.md), @ref:[Scala](../scala/persistence.md))fails (by stopping) with a persistence failure - which indicates that
...
**Routing** ([@ref:[Java](../java/routing.md)], [@ref:[Scala](../scala/routing.md)]).
