...
supported by At-Least-Once Delivery (@ref:[Java](../java/persistence.md#at-least-once-delivery), @ref:[Scala](../scala/persistence.md#at-least-once-delivery)) of the Akka Persistence module. Duplicates can be
detected by tracking the identifiers of messages sent via At-Least-Once Delivery (@ref:[Java](../java/persistence.md#at-least-once-delivery), @ref:[Scala](../scala/persistence.md#at-least-once-delivery)).
...
snapshots to speed up the process). Event sourcing(../scala/persistence.md#event-sourcing) (@ref:[Java](../java/persistence.md#event-sourcing), @ref:[Scala](../scala/persistence.md#event-sourcing)) is supported by
Akka Persistence.
...
stream, see Event Stream (@ref:[Java](../java/event-bus.md#event-stream), @ref:[Scala](../scala/event-bus.md#event-stream))
