...
A good practice is to place those settings in an Extension (@ref:[Java](../java/extending-akka.md#extending-akka-settings), @ref:[Scala](../scala/extending-akka.md#extending-akka-settings)) 
